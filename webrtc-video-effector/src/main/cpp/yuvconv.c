...
Java_com_github_kei9327_webrtc_video_effector_format_LibYuvBridge_i420ToAbgrInternal(
    JNIEnv *env,
    jobject obj,
...
JNIEXPORT void JNICALL
Java_com_github_kei9327_webrtc_video_effector_format_LibYuvBridge_abgrToI420Internal(
        JNIEnv *env,
        jobject obj,
        jobject rgbaBuffer,
        jint width,
