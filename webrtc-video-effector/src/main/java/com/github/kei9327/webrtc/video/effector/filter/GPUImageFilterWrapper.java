package com.github.kei9327.webrtc.video.effector.filter;

import android.opengl.GLES20;

import com.github.kei9327.webrtc.video.effector.VideoEffectorContext;
...
public class GPUImageFilterWrapper extends FrameImageFilter {
    ...
    public void updateShader(GPUImageFilter shaderGroup, int width, int height) {
        GPUImageFilter oldFilter = originalFilter;
        originalFilter = shaderGroup;
        ...
        originalFilter.onInit();
        originalFilter.onOutputSizeChanged(width, height);
    }
