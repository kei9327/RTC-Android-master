...
import com.github.kei9327.webrtc.video.effector.camera.EffectCamera1Enumerator;
...
public class CallActivity extends Activity implements AppRTCClient.SignalingEvents,
  ...
  private RTCVideoEffector mEffector;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    mEffector = new RTCVideoEffector(this);
  ...
  @Override
  public void updateShader(GPUImageFilter imageFilter) {
    mEffector.updateShader(imageFilter);
  }
...
//      videoCapturer = createCameraCapturer(new Camera2Enumerator(this));
      videoCapturer = createCameraCapturer(new EffectCamera1Enumerator(mEffector));
    } else {
