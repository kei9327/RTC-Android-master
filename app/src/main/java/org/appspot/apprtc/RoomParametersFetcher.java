  ...
  private void roomHttpResponseParse(String response) {
    ...
    try {
      ...
      String turnServerOverride = "{\n" +
              ...
              "        \"turn:[2404:6800:4008:c04::7f]:19305?transport=udp\",\n" +
              "        \"turn:74.125.204.127:19305?transport=tcp\",\n" +
              "        \"turn:[2404:6800:4008:c04::7f]:19305?transport=tcp\"\n" +
              "      ],\n" +
              "      \"username\": \"CJaw1+AFEgbGO9yCIG8Yzc/s6OMTIICjBQ\",\n" +
              "      \"credential\": \"ef2pUvUN56q2Fs6B31GdulxZtIE=\",\n" +
              "      \"maxRateKbps\": \"8000\"\n" +
              "    }\n" +
              "  ],\n" +
      ...
      List<PeerConnection.IceServer> iceServers =
          iceServersFromPCConfigJSON(turnServerOverride);
//          iceServersFromPCConfigJSON(roomJson.getString("pc_config"));
  ...
  private List<PeerConnection.IceServer> iceServersFromPCConfigJSON(String pcConfig)
    ...
    JSONArray iceServers = json.getJSONArray("iceServers");
    for (int i = 0; i < iceServers.length(); ++i) {
      JSONObject server = iceServers.getJSONObject(i);
      JSONArray turnUrls = server.getJSONArray("urls");
      String username = server.has("username") ? server.getString("username") : "";
